...
const greeting = {
  ...
  subTitle: emoji(
    "I'm a curious student pursuing software development and continuously strive to stay up-to-date with the latest advancements in technology, a.k.a a nerd but who enjoys music too (and plays it as well)."
  ),
  resumeLink:
